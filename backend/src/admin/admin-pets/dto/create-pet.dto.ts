...
export class CreatePetDto {
  ...
  @ApiPropertyOptional({ description: 'Se o animal tem comorbidades', example: false, default: false })
  @IsBoolean()
  @IsOptional()
  comorbidade?: boolean;
  ...
  @ApiPropertyOptional({ description: 'Foto do animal em formato Base64' })
  @IsString()
  @IsOptional()
  foto?: string;
}