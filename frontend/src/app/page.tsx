  ...
  return (
    <div className="min-h-screen bg-adotai-fundo flex flex-col pb-12">
      ...
      <main className="flex-1 flex flex-col mt-12">
        ...
        <div className="bg-adotai-fundoCard w-full rounded-adotai border border-adotai-textoSecundario p-8 md:p-16 relative flex flex-col md:flex-row items-center justify-between min-h-[380px] overflow-visible mb-6">
          
          {/* Lado Esquerdo: Títulos e Textos */}
          <div className="flex-1 space-y-6 max-w-xl z-10">
            <h1 className="text-5xl md:text-6xl font-title font-extrabold text-adotai-textoPrincipal leading-tight whitespace-pre-line">
              Faça match {"\n"} com seu pet
            </h1>
